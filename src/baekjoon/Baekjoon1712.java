...
public class Baekjoon1712 {
    public static void main(String[] args)throws IOException{
        ...
        int A = Integer.parseInt(st.nextToken()); // 재산세 급여 등 고정 비용
        int B = Integer.parseInt(st.nextToken()); // 재료비 인건비 등 가변 비용
        int C = Integer.parseInt(st.nextToken()); // 판매가격 = 고정+가변비용 보다 많아지게 되는 구간
        int cnt = 0;
